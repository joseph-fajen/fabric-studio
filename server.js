...
async function startServer() {
  ...
  try {
    ...
    server.listen(PORT, '0.0.0.0', async () => {
      console.log(`🚀 Fabric Studio running on port ${PORT}`);
...
function createTranscriptIndexContent(metadata) {
  ...
  indexContent += `This content was processed using Fabric Studio's fabric patterns. `;
  ...
  indexContent += `---\n`;
  indexContent += `*Generated by Fabric Studio*\n`;
